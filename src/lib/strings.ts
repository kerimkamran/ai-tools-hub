...
const en = {
  ...
  assistant: {
    ...
    title: "Assistant",
    intro:
      "Ask Alexander about the tools in this hub and the knowledge base. Answers are in the language you ask in.",
...
const az: Strings = {
  ...
  assistant: {
    ...
    title: "Köməkçi",
    intro:
      "Bu kataloqdakı alətlər və bilik bazası barədə Aleksandrdan soruşun. Cavab sualı verdiyiniz dildə olacaq.",
...
const ru: Strings = {
  ...
  assistant: {
    ...
    title: "Ассистент",
    intro:
      "Спрашивайте Александра об инструментах каталога и базе знаний. Ответ будет на языке вопроса.",
